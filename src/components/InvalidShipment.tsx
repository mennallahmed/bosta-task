...
const InvalidShipment = () => {
  return (
    <div className="container flex items-start gap-3 mx-auto w-11/12 md:w-3/5 bg-[#fef3f2] text-xl font-semibold border border-[#fecdca] mt-24 p-4 md:p-10 rounded-2xl">
